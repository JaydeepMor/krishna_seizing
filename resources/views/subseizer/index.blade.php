                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group btn-group">
                                            <a href="{{ route('subseizer.edit', $user->id) }}" data-toggle="tooltip" title="" class="btn btn-default" data-original-title="{{ __('Clear Sync') }}"><i class="fa fa-circle-o-notch"></i></a>
