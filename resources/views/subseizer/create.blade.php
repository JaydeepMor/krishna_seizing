...
@section('content')
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-table"></i>{{ __('Create Sub Seizer') }}
            </h1>
        </div>
    </div>
    <!-- END Page Header -->
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <input type="text" id="team_leader" name="team_leader" class="form-control" value="{{ old('team_leader') }}" />
                                        @error('team_leader')
                                            <em class="color-red error invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </em>
                            ...
                            <div class="col-md-6">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <input type="text" id="imei_number" name="imei_number" class="form-control" value="{{ old('imei_number') }}" required />
                                        @error('imei_number')
                                            <em class="color-red error invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </em>
                                        ...
                                        <select class="form-control" name="status">
                                            ...
                                            @if (!empty($modal->statuses))
                                                @foreach ($modal->statuses as $key => $status)
                                                    @php
                                                        $selected = ((old('status', $modal::STATUS_INACTIVE) >= '0') && old('status', $modal::STATUS_INACTIVE) == $key) ? 'selected' : '';
                                                    @endphp
                                        ...
                                        <div class="form-group">
                                            <select name="vehicle_allowed_fields[]" id="vehicle_allowed_fields" multiple="multiple" class="form-control multiselect-inline">
                                                @foreach ($vehicleFields as $vehicleField)
                                                    <option value="{{ $vehicleField }}" {{ in_array($vehicleField, old('vehicle_allowed_fields', $vehicleDefaultFields)) ? 'selected' : '' }}>{{ $vehicleField }}</option>
                                                @endforeach
                                            </select>
