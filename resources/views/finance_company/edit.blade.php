...
@section('content')
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-table"></i>{{ __('Edit Finance Company') }}
            </h1>
        </div>
    </div>
    <!-- END Page Header -->
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <input type="text" id="name" name="name" class="form-control" autofocus value="{{ old('name', $row->name) }}" required="true" />
                                        @error('name')
                            ...
                            <div class="col-md-6">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <textarea name="address" id="address" class="form-control">{{ old('address', $row->address) }}</textarea>
                                        @error('address')
                                            <em class="color-red error invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </em>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <input type="text" id="contact_person" name="contact_person" class="form-control" value="{{ old('contact_person', $row->contact_person) }}" />
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <input type="text" id="branch_code" name="branch_code" class="form-control" value="{{ old('branch_code', $row->branch_code) }}" />
                                        @error('branch_code')
                                            <em class="color-red error invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </em>
                            ...
                            <div class="col-md-6">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <input type="text" id="branch_name" name="branch_name" class="form-control" value="{{ old('branch_name', $row->branch_name) }}" />
                                        @error('branch_name')
                                            <em class="color-red error invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </em>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <input type="text" id="email" name="email" class="form-control" value="{{ old('email', $row->email) }}" />
                                        @error('email')
                                            <em class="color-red error invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </em>
                                    ...
                                    <div class="form-group">
                                        <select name="finance_ho_id" id="finance_ho_id" class="form-control">
                                            ...
                                            @if (!empty($financeHos) && !$financeHos->isEmpty())
                                                @php
                                                    $financeHoId = old('finance_ho_id', $row->finance_ho_id);
                                                @endphp

                                                @foreach ($financeHos as $financeHo)
                                                    <option value="{{ $financeHo->id }}" {{ ($financeHo->id == $financeHoId) ? "selected" : "" }}>{{ $financeHo->name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                        @error('finance_ho_id')
